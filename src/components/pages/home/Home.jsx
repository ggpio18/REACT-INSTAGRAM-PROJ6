      ...
      <div class="flex md:flex-row-reverse flex-wrap">
        <div class="w-full md:w-3/4 p-4 text-center">
          <div class="text-left pl-4 pt-3">
            <span class="text-base text-gray-700 text-2xl mr-2">Pio Aranza</span>
          ...
          <div class="text-left pl-4 pt-3">
            <span class="text-lg font-bold text-gray-700 mr-2">Pio Aranza</span>
          </div>
          ...
          <div class="text-left pl-4 pt-3">
            ...
            >https://www.behance.net/ggpio187855</p>
          </div>
        </div>
